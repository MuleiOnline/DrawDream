import cv2
import os
images_folder = 'D:\DrawDream-main\video-test\cropped_images'
output_video_path = 'D:\DrawDream-main\video-test'

def create_video_from_images(images_folder, output_video_path, frame_rate=1, size=(341, 521)):
